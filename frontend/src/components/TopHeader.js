...
const TopHeader = () => {
    const { vendor, logout, status } = useAuth();
    ...
    return (
        <header className="top-header">
            {/* 1. Brand / Logo */}
            <div className="header-brand" onClick={() => navigate("/vendor/dashboard")}>
                <div className="brand-icon">
                    {/* Diamond Icon SVG - Matching User Request */}
            ...
            <div className="header-right">
                ...
                {/* Shop Name (Small) */}
                <span className="shop-name">{vendor?.shopName?.toUpperCase() || "MY SHOP"}</span>
